...
export function ServiceHero({ onStartWizard, className }: ServiceHeroProps) {
  ...
  return (
    <section className={cn("relative overflow-hidden bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-50 dark:from-gray-900 dark:via-sky-900 dark:to-cyan-900 py-20 lg:py-32", className)}>
      {/* Background Pattern */}
          ...
          >
            ...
            >
              <Button
                ...
                size="lg"
                className="bg-gradient-to-r from-sky-500 to-cyan-600 hover:from-sky-600 hover:to-cyan-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 group px-8 py-3"
