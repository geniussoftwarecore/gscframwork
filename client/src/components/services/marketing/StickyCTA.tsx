        ...
        {isVisible && (
          ...
          >
            <Button
              ...
              size="lg"
              className="w-14 h-14 rounded-full bg-gradient-to-r from-sky-500 to-cyan-600 hover:from-sky-600 hover:to-cyan-700 text-white shadow-2xl hover:shadow-sky-500/25 transition-all duration-300 p-0"
            ...
            <CardContent className="p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-gradient-to-r from-sky-500 to-cyan-600 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-sky-500 to-cyan-600 hover:from-sky-600 hover:to-cyan-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 group"
